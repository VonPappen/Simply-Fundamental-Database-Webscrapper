...
Revision ID: 6f0997ad69dc
Revises: 57ae6623d141
Create Date: 2021-09-14 18:46:55.671880
...
revision = '6f0997ad69dc'
down_revision = '57ae6623d141'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.UniqueConstraint('date', 'ticker', 'line_item', name='unique_entry')
    )
